...
*   **description** (String): A brief summary of the checks used.
    *   *Example:* "Removed negative values and flat-lined data > 2 hours."
...
*   **description** (String): Summary of the correction method.
    *   *Example:* "Adjusted using the EPA's national correction factor for PurpleAir PM2.5."
...
*   **description** (String): Who reviewed it and what was the criteria?
    *   *Example:* "Quarterly review by data manager to remove maintenance periods."
